...
class _R_Text_AssetResource {
  ...
  /// asset: lib/assets/texts/jsons/city.json
  // ignore: non_constant_identifier_names
  final city_json = const AssetResource("assets/texts/jsons/city.json",
...
class _R_Text {
  ...
  /// asset: lib/assets/texts/jsons/city.json
  // ignore: non_constant_identifier_names
  Future<String> city_json() {
    final str = rootBundle.loadString(asset.city_json.keyName);
    return str;
  }
}
